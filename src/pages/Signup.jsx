...
export default function Signup() {
  ...
  const [form, setForm] = useState({ name: '', email: '', password: '', role: 'member', adminSecret: '' });
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      await signup(form.name, form.email, form.password, form.role, form.adminSecret);
    } catch (err) {
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        <div className="logo" style={{ margin: '0 auto 24px' }}>T</div>
